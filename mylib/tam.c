...
{   
    ...
    if(xTaskCreate(func_3, "task_3", 512, NULL, 4, &task_3) != pdPASS)
    {
        while(1);
    }

    if(xTaskCreate(func_4, "task_4", 512, NULL, 5, &task_4) != pdPASS)
    {
        while(1);
    }
    if(xTaskCreate(func_5, "task_5", 512, NULL, 2, &task_5) != pdPASS)
    {
        while(1);
    }
    if(xTaskCreate(func_8, "task_8", 512, NULL, 4, &task_8) != pdPASS)
    {
        while(1);
    }
    if(xTaskCreate(func_6, "task_6", 512, NULL, 2, &task_6) != pdPASS)
    {
        while(1);
    }
    if(xTaskCreate(func_7, "task_7", 512, NULL, 4, &task_7) != pdPASS)
    {
        while(1);
    }
    vTaskStartScheduler(); 
